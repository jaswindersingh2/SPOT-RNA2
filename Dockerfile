...
RUN wget 'https://www.dropbox.com/s/vgv73vklqq2v554/SPOT-RNA2.tar.xz' || wget 'https://app.nihaocloud.com/f/3e826caf8efc43adaaa0/?dl=1' && tar -xvf SPOT-RNA2.tar.xz && rm SPOT-RNA2.tar.xz
WORKDIR SPOT-RNA2
